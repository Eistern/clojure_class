...
4. Подумать, как потенциально можно ускорить поиск класса по имени?. Базовый вариант - обход дерева классов
5. Объекты хранятся в памяти. Объект представляет собой значение его атрибутов (определенных в самом классе и наследованных от суперклассов), имя класса, имя объекта
...
|---|---|---|
|Реализация классов, их сохранения в памяти|   |   |
|Реализация создания объектов, функций чтения/записи атрибутов|   |   |
|Добавление наследования к классам, в том числе множественного|   |   |
|Реализация базовых возможностей динамического полиморфизма с наивной реализацией сортировки для одного параметра|   |   |

Дополнительный функционал:

|Описание|Дата завершения|Ответственный за реализацию|
|---|---|---|
|Разработка и реализация алгоритма сортировки для множественного наследования и нескольких параметров в методе|   |   |
|Реализация call-next-method|   |   |
|Разработка before-after методов|   |   |
